<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('sopraSteriaApp.label.home.title')" id="label-heading">Labels</span>
            <router-link :to="{name: 'LabelCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-label">
                ...
                <span  v-text="$t('sopraSteriaApp.label.home.createLabel')">
                    Create a new Label
                </span>
            </router-link>
        </h2>
        ...
        <div class="alert alert-warning" v-if="!isFetching && labels && labels.length === 0">
            <span v-text="$t('sopraSteriaApp.label.home.notFound')">No labels found</span>
        </div>
        <div class="table-responsive" v-if="labels && labels.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('sopraSteriaApp.label.label')">Label</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="sopraSteriaApp.label.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-label-heading" v-text="$t('sopraSteriaApp.label.delete.question', {'id': removeId})">Are you sure you want to delete this Label?</p>
            </div>
