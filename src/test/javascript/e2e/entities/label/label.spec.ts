...
describe('Label e2e test', () => {
  ...
  describe('Create flow', () => {
    it('should load create Label page', async () => {
      ...
      expect(await updatePage.title.getAttribute('id')).to.match(/sopraSteriaApp.label.home.createOrEditLabel/);
    });

    it('should create and save Labels', async () => {
      await updatePage.labelInput.sendKeys('label');
      expect(await updatePage.labelInput.getAttribute('value')).to.match(/label/);
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        expect(await deleteDialog.title.getAttribute('id')).to.match(/sopraSteriaApp.label.delete.question/);
      ...
      it('should load edit Label page, fetch data and update', async () => {
        ...
        await updatePage.labelInput.clear();
        await updatePage.labelInput.sendKeys('modified');
        expect(await updatePage.labelInput.getAttribute('value')).to.match(/modified/);
