...
export default class ProjectComponentsPage extends AlertPage {
...
export class ProjectDeleteDialog {
  ...
  title: ElementFinder = element(by.id('sopraSteriaApp.project.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-project'));
}
