...
export default class TicketComponentsPage extends AlertPage {
...
export class TicketDeleteDialog {
  ...
  title: ElementFinder = element(by.id('sopraSteriaApp.ticket.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-ticket'));
}
